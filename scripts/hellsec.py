...
# Function to build a random ASCII string
def buildblock(size):
    out_str = ''
    for i in range(0, size):
        # Ensure the random character is a printable ASCII character
        a = random.randint(32, 126)  # ASCII range for printable characters
        out_str += chr(a)
    return out_str
